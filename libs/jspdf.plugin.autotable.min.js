            ...
            Object.defineProperty(e, "__esModule", { value: !0 }),
              (e.default = function (t, e, n, o, r) {
                ...
                var i = r.internal.scaleFactor,
                  ...
                  a =
                    l *
                    (r.getLineHeightFactor ? r.getLineHeightFactor() : 1.15),
                  s = "",
                  u = 1;
                if (
                  (("middle" !== o.valign &&
          ...
          259: function (t, e, n) {
            ...
            e.parseCss = function (t, e, n, i, l) {
              ...
              var c = "borderTopColor",
                ...
                g = i.borderTopWidth;
              if (
                i.borderBottomWidth === g &&
                i.borderRightWidth === g &&
                i.borderLeftWidth === g
              ) {
              ...
              -1 !== v.indexOf(i.textAlign) && (a.halign = i.textAlign),
                -1 !==
                  (v = ["middle", "bottom", "top"]).indexOf(i.verticalAlign) &&
              ...
              o = (function () {
                ...
                return (
                  ...
                  (t.prototype.getLineHeight = function (t) {
                    return (
                      (t / this.scaleFactor()) * this.getLineHeightFactor()
                    );
                  }),
              ...
              var c = (function (t, e, n) {
                ...
                g = (function (t, e) {
                  var n,
                    ...
                    p,
                    y,
                    v = (0, i.parseSpacing)(e.margin, 40 / t.scaleFactor()),
                    m =
                      null !==
                        (n = (function (t, e) {
              ...
              l = (function () {
                ...
                return (
                  ...
                  (t.prototype.callWillDrawPageHooks = function (t, e) {
                    for (
                      var n = 0, o = this.hooks.willDrawPage;
                      n < o.length;
                      n++
                    ) {
                      (0, o[n])(new r.HookData(t, this, e));
          ...
          49: function (t, e, n) {
            ...
            function d(t, e, n, o, r, i) {
              ...
              var l = Math.min(n + i, e.body.length),
                a = -1;
              return (
                e.body.slice(n, l).forEach(function (i, l) {
                ...
                var d = (function (t, e, n, o) {
                  ...
                  for (var a = 0, s = 0, u = n.columns; s < u.length; s++) {
                    ...
                    if ((b = t.cells[d.index])) {
                      ...
                      var f = c(b, e, o);
                      b.text.length > f &&
                        (h.text = b.text.splice(f, b.text.length));
                      var g = o.scaleFactor(),
                        p = o.getLineHeightFactor();
                      (b.contentHeight = b.getContentHeight(g, p)),
                        b.contentHeight >= e &&
                          ((b.contentHeight = e),
                          (h.styles.minCellHeight -= e)),
                        b.contentHeight > t.height &&
                          (t.height = b.contentHeight),
                        (h.contentHeight = h.getContentHeight(g, p)),
                        h.contentHeight > a && (a = h.contentHeight),
                        (i[d.index] = h);
                    }
                  }
                  ...
                  for (var v = 0, m = n.columns; v < m.length; v++) {
                    var b;
                    (d = m[v]),
                      (h = y.cells[d.index]) && (h.height = y.height),
                      (b = t.cells[d.index]) && (b.height = t.height);
                  }
                  return y;
                })(n, u, e, t);
              ...
              for (var i = 0, l = r; i < l.length; i++) {
                ...
                if (u)
                  if (
                    ...
                    (u.x = o.x),
                    (u.y = o.y),
                    !1 !== e.callCellHooks(t, e.hooks.willDrawCell, u, n, s, o))
                  ) {
                    p(t, u, o);
                    var d = u.getTextPos();
                    (0, a.default)(
                      ...
                      e.callCellHooks(t, e.hooks.didDrawCell, u, n, s, o),
                      (o.x += s.width);
                  } else o.x += s.width;
                else o.x += s.width;
              }
            ...
            function p(t, e, n) {
              ...
              if (
                ...
                "object" == typeof r.lineWidth &&
                  (r.fillColor && t.rect(e.x, n.y, e.width, e.height, "F"),
                  (function (t, e, n, o) {
                    var r, i, l, a;
                    o.top &&
                      ((r = n.x),
            ...
            function m(t) {
              var e = t.pageNumber();
              return (
                t.setPage(e + 1), t.pageNumber() === e && (t.addPage(), !0)
              );
            }
            (e.drawTable = function (t, e) {
              ...
              ("always" === n.pageBreak ||
                (null != n.startY && y > b.pageSize().height)) &&
                (m(b), (c.y = a.top)),
                ...
                n.horizontalPageBreak
                  ? (function (t, e, n, o) {
                      var r = (0, s.calculateAllColumnsCanFitInPage)(t, e),
                        i = e.settings;
                      if ("afterAllRows" === i.horizontalPageBreakBehaviour)
                        r.forEach(function (r, i) {
                          t.applyStyles(t.userStyles),
                            i > 0
                              ? v(t, e, n, o, r.columns, !0)
                              : u(t, e, o, r.columns),
                            (function (t, e, n, o, r) {
                              t.applyStyles(t.userStyles),
              ...
              e.settings.horizontalPageBreakRepeat,
                ...
                u.forEach(function (t) {
                  ...
                  n &&
                    ...
                    (l.set(n.index, !0),
                    a.push(n.index),
                    s.push(e.columns[n.index]),
                    (i -= n.wrappedWidth));
                });
              for (
                var d = !0,
                  h =
                    null !== (r = null == n ? void 0 : n.start) && void 0 !== r
                      ? r
                      : 0;
                h < e.columns.length;
